...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const url =
        'https://datahub-backend-1d73729e6f15.herokuapp.com/api/users'; // Your backend endpoint
      const { data: res } = await axios.post(url, formData); // Sending data to backend
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full xl:w-1/2">
            <div className="p-8 sm:p-12.5">
              ...
              {successMessage && ( // Render success message if exists
                <div
