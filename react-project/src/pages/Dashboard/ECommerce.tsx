  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        ...
        setTotalFiles(response.data.length); // Set total number of files
      } catch (error) {
    ...
    const fetchMemoryConsumed = async () => {
      try {
        ...
        setMemoryConsumed(response.data.sizeGB);
      } catch (error) {
  ...
  return (
    <DefaultLayout>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats title="Total Memory" total="5 GB" rate="4.35%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
